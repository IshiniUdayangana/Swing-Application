	...
	UpdateCustomerForm(){
		...
		btnUpdate.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
				...
				boolean isUpdate=CustomerDBConnection.getInstance().getCustomerCollection().update(c1);
				if(isUpdate){
		...
		txtId.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
				Customer c1=CustomerDBConnection.getInstance().getCustomerCollection().search(txtId.getText());
				if(c1==null){
