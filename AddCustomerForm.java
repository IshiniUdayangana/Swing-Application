...
class AddCustomerForm extends JFrame{
	...
	AddCustomerForm(){
		...
		btnAdd.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
				...
				CustomerDBConnection ob=CustomerDBConnection.getInstance();
				CustomerCollection customerCollection=ob.getCustomerCollection();
	...
	private String generateCustomerId(){
		CustomerCollection customerCollection=CustomerDBConnection.getInstance().getCustomerCollection();
